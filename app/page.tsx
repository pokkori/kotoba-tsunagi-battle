      ...
      <div className="max-w-sm w-full space-y-8 text-center">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-lg font-bold rounded-2xl shadow-lg hover:from-blue-700 hover:to-indigo-700 active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button
            ...
            disabled={!ready}
            className="w-full py-4 border-2 border-gray-300 text-gray-700 text-lg font-bold rounded-2xl hover:bg-gray-50 active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            フリープレイ
          </button>
        </div>
